 ...
 * 
 * @author L.Yang
 * @version v1.0 2017年3月15日 下午4:53:20
 */
@Aspect
@Component
public class WebLogAspect {
    ...
    @Pointcut("execution(public * org.liang.web..*.*(..))")
    public void webLog() {}
    ...
    public void doAfterReturning(Object ret) throws Throwable {
        ...
        LOGGER.trace("SPEND TIME : " + (System.currentTimeMillis() - startTime.get()));
    }
}
